...
<div class="addPersonBox">
    <div class="login_internal">
        <form id="login_form">
            <h2 class="text-center">网站管理人员添加</h2>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="inputRemark" name="password" placeholder="备注，该字段可以不填写"
                       required>
            </div>
            <div class="col-sm-offset-1 col-sm-4">
                <button type="button" class="btn btn-primary btn-block" onclick="addPerson();">添加
                </button>
            </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.message == "success") {
                        ...
                        $("#add_person_return_message").text("该用户原来已存在，可以进入管理人员管理页面进行管理");
                    }
                }
            });
        }
